...
- **Status:** draft (gate for Track E1 — Dialer subsystem · order 2, alongside Numbers)
...
- None — GHL is not involved. Data originates from an external spam/flag report (see Open questions).
...
## Open questions
- **CSV source & schema:** which system exports the flagged-numbers CSV (Hiya? a carrier? Dialpad?), and is its column schema stable? (Drives the parser.)
